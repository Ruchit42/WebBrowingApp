...
public class BookMarkAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(v == null){
            ...
            v = inflater.inflate(R.layout.custombooklist, null);
        }

        TextView bookMarkTextView = (TextView) v.findViewById(R.id.mytextview);

        bookMarkTextView.setText(bookMarksList.get(i).get_web_Title());

        ImageButton DelButton = (ImageButton) v.findViewById(R.id.deletebutton);
